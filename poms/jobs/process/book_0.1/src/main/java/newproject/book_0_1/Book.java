 ...
 * @status
 */
public class Book implements TalendJob {
	...
	private final String jobName = "Book";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Book.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_NEWPROJECT_Book = new byte[0];
		static byte[] commonByteArray_NEWPROJECT_Book = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_NEWPROJECT_Book.length) {
					if (length < 1024 && commonByteArray_NEWPROJECT_Book.length == 0) {
						commonByteArray_NEWPROJECT_Book = new byte[1024];
					} else {
						commonByteArray_NEWPROJECT_Book = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_NEWPROJECT_Book, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_Book, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_NEWPROJECT_Book, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_Book, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NEWPROJECT_Book) {

				try {

					int length = 0;

					this.emptyField = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.emptyField, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("emptyField=" + emptyField);
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fileName_tFileOutputExcel_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/outBook.xls";
...
//create directory only if not exists
				...
				if (startRowNum_tFileOutputExcel_1 == 0) {
					...
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(0, nb_line_tFileOutputExcel_1, "emptyField"));
					// modif end
					fitWidth_tFileOutputExcel_1[0] = fitWidth_tFileOutputExcel_1[0] > 10
					...
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(2, nb_line_tFileOutputExcel_1, "Name"));
					// modif end
					fitWidth_tFileOutputExcel_1[2] = fitWidth_tFileOutputExcel_1[2] > 4 ? fitWidth_tFileOutputExcel_1[2]
							: 4;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(3, nb_line_tFileOutputExcel_1, "Street"));
					// modif end
					fitWidth_tFileOutputExcel_1[3] = fitWidth_tFileOutputExcel_1[3] > 6 ? fitWidth_tFileOutputExcel_1[3]
							: 6;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(4, nb_line_tFileOutputExcel_1, "Amount"));
					// modif end
					fitWidth_tFileOutputExcel_1[4] = fitWidth_tFileOutputExcel_1[4] > 6 ? fitWidth_tFileOutputExcel_1[4]
							: 6;
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:oLE3ZOxvu4uOlnloU/aEDQrGTwMgEbIzf5p6MQ==");
				...
				Object source_tFileInputExcel_1 = "D:/Data/Data Engineering_ITI/Data Exploration and preparation/day_5/data/intake3/Book1.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.Amount = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Amount = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "row1"
							if (row1 != null) {
								...
								row1.Amount = StringUtils.replaceAllStrictly(row1.Amount, searchStr_tReplace_1_1,
										"," + "", false, false);
								String searchStr_tReplace_1_2 = "streat" + "";
								row1.Street = StringUtils.replaceAllStrictly(row1.Street, searchStr_tReplace_1_2,
										"street" + "", false, false);
								String searchStr_tReplace_1_3 = "$" + "";
								row1.Amount = StringUtils.replaceAllStrictly(row1.Amount, searchStr_tReplace_1_3,
										"£" + "", false, false);
								String searchStr_tReplace_1_4 = "nikson" + "";
								row1.Name = StringUtils.replaceAllStrictly(row1.Name, searchStr_tReplace_1_4,
										"Nixon" + "", false, false);
								String searchStr_tReplace_1_5 = "georg*t" + "";
								row1.FirstName = StringUtils.replaceAllStrictly(row1.FirstName, searchStr_tReplace_1_5,
										"george" + "", false, false);
								String searchStr_tReplace_1_6 = "richard" + "";
								row1.FirstName = StringUtils.replaceAllStrictly(row1.FirstName, searchStr_tReplace_1_6,
										"Richard" + "", false, false);
								row2.Street = row1.Street;
...
//modif ends							
	...
	public static void main(String[] args) {
		final Book BookClass = new Book();

		int exitCode = BookClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Book.class.getClassLoader()
					.getResourceAsStream("newproject/book_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Book.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Book");
		}
...
/************************************************************************************************
 * 73477 characters generated by Talend Open Studio for Data Integration on the
 * October 17, 2023 at 5:14:54 PM EET
 ************************************************************************************************/