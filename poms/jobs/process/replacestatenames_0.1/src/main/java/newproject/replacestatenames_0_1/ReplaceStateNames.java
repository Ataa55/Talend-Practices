...
package newproject.replacestatenames_0_1;
...
/**
 * Job: ReplaceStateNames Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class ReplaceStateNames implements TalendJob {
	...
	private final String jobName = "ReplaceStateNames";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ReplaceStateNames.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ReplaceStateNames.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_NEWPROJECT_ReplaceStateNames = new byte[0];
		static byte[] commonByteArray_NEWPROJECT_ReplaceStateNames = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_NEWPROJECT_ReplaceStateNames.length) {
					if (length < 1024 && commonByteArray_NEWPROJECT_ReplaceStateNames.length == 0) {
						commonByteArray_NEWPROJECT_ReplaceStateNames = new byte[1024];
					} else {
						commonByteArray_NEWPROJECT_ReplaceStateNames = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_NEWPROJECT_ReplaceStateNames, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_ReplaceStateNames, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_NEWPROJECT_ReplaceStateNames, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_ReplaceStateNames, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NEWPROJECT_ReplaceStateNames) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "name", "state", });
...
///////////////////////    			
				...
				java.util.Map<row3Struct, row3Struct> tMap_row3_tReplaceList_1 = (java.util.Map<row3Struct, row3Struct>) globalMap
						.get("tHash_row3");
				java.util.Map<String, String> replace_tReplaceList_1 = new java.util.LinkedHashMap<String, String>();

				for (Object o : tMap_row3_tReplaceList_1.keySet()) {

					String search = tMap_row3_tReplaceList_1.get(o).state;
					String replacement = tMap_row3_tReplaceList_1.get(o).code;
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						"D:/Data/Data Engineering_ITI/Data Exploration and preparation/day_5/intake3-20231017T062812Z-001/intake3/treplace/name_state.csv"/**
																																							 * End
																																							 * field
									...
									if (o.getClass().getSimpleName().equals("String")) {
										...
										if (replace_tReplaceList_1.get(o) == null || replace_tReplaceList_1.get(o)
											...
											String replacetReplaceList_1 = (null != replace_tReplaceList_1.get(o))
													...
													: "";
											final String searchPatterntReplaceList_1 = java.util.regex.Pattern
													.quote(searchtReplaceList_1);
											inputFlow_tReplaceList_1_state = inputFlow_tReplaceList_1_state
													.replaceAll(searchPatterntReplaceList_1, replacetReplaceList_1);
										}
									}
								}
							}
...
///////////////////////		
							...
							if (row2.state != null) { //
								row_tLogRow_1[1] = String.valueOf(row2.state);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */
						"D:/Data/Data Engineering_ITI/Data Exploration and preparation/day_5/intake3-20231017T062812Z-001/intake3/treplace/state.csv"/**
																																						 * End
																																						 * field
						...
						try {
							...
							if (rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row3.code = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
// Start of branch "row3"
	...
	public static void main(String[] args) {
		final ReplaceStateNames ReplaceStateNamesClass = new ReplaceStateNames();

		int exitCode = ReplaceStateNamesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ReplaceStateNames.class.getClassLoader()
					.getResourceAsStream("newproject/replacestatenames_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ReplaceStateNames.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : ReplaceStateNames");
		}
...
/************************************************************************************************
 * 82983 characters generated by Talend Open Studio for Data Integration on the
 * October 17, 2023 at 10:51:59 AM EET
 ************************************************************************************************/