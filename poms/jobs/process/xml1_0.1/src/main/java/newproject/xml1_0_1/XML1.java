 ...
 * @status
 */
public class XML1 implements TalendJob {
	...
	private final String jobName = "XML1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(XML1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_NEWPROJECT_XML1 = new byte[0];
		static byte[] commonByteArray_NEWPROJECT_XML1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_NEWPROJECT_XML1.length) {
					if (length < 1024 && commonByteArray_NEWPROJECT_XML1.length == 0) {
						commonByteArray_NEWPROJECT_XML1 = new byte[1024];
					} else {
						commonByteArray_NEWPROJECT_XML1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_NEWPROJECT_XML1, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_XML1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_NEWPROJECT_XML1, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_XML1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NEWPROJECT_XML1) {
	...
	public void tFileInputXML_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fileName_tFileOutputExcel_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/XML.xls";
				...
				if (xlsxTool_tFileOutputExcel_1.getStartRow() == 0) {
					...
					xlsxTool_tFileOutputExcel_1.addCellValue("mode");
				...
				try {
					filename_tFileInputXML_1 = "D:/Data/Data Engineering_ITI/Data Exploration and preparation/day_5/intake3-20231017T062812Z-001/intake3/payment.xml";
				...
				if (isValidFile_tFileInputXML_1) {
					...
					org.dom4j.XPath x_tFileInputXML_1 = doc_tFileInputXML_1
							.createXPath(nsTool_tFileInputXML_1.addDefaultNSPrefix("/paymentModes/paymentMode"));
					...
					class XPathUtil_tFileInputXML_1 {
						...
						public void initXPaths_0(java.util.Map<Integer, org.dom4j.XPath> xpaths,
							...
							org.dom4j.XPath xpath_0 = org.dom4j.DocumentHelper
									.createXPath(nsTool.addDefaultNSPrefix("id", "/paymentModes/paymentMode"));
							xpath_0.setNamespaceURIs(xmlNameSpaceMap);

							xpaths.put(0, xpath_0);

							org.dom4j.XPath xpath_1 = org.dom4j.DocumentHelper
									.createXPath(nsTool.addDefaultNSPrefix("mode", "/paymentModes/paymentMode"));
					...
					for (org.dom4j.Node temp_tFileInputXML_1 : nodeList_tFileInputXML_1) {
						...
						try {
							...
							if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
								...
								row1.id = ParserUtils.parseTo_Integer(str_tFileInputXML_1);
							}
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row1.id != null) {
								...
								xlsxTool_tFileOutputExcel_1.addCellValue(Double.parseDouble(String.valueOf(row1.id)));
							} else {
							...
							if (row1.mode != null) {
								...
								xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row1.mode));
							} else {
								xlsxTool_tFileOutputExcel_1.addCellNullValue();
							}
	...
	public static void main(String[] args) {
		final XML1 XML1Class = new XML1();

		int exitCode = XML1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = XML1.class.getClassLoader()
					.getResourceAsStream("newproject/xml1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = XML1.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : XML1");
		}
...
/************************************************************************************************
 * 47445 characters generated by Talend Open Studio for Data Integration on the
 * October 17, 2023 at 11:37:56 AM EET
 ************************************************************************************************/