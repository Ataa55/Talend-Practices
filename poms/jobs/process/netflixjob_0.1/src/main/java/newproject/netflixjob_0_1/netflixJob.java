...
package newproject.netflixjob_0_1;
 ...
 * @status
 */
public class netflixJob implements TalendJob {
	...
	private final String jobName = "netflixJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(netflixJob.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
		final static byte[] commonByteArrayLock_NEWPROJECT_netflixJob = new byte[0];
		static byte[] commonByteArray_NEWPROJECT_netflixJob = new byte[0];
		...
		public Integer MovieCoount;

		public Integer getMovieCoount() {
			return this.MovieCoount;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_NEWPROJECT_netflixJob.length) {
					if (length < 1024 && commonByteArray_NEWPROJECT_netflixJob.length == 0) {
						commonByteArray_NEWPROJECT_netflixJob = new byte[1024];
					} else {
						commonByteArray_NEWPROJECT_netflixJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_NEWPROJECT_netflixJob, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_netflixJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_NEWPROJECT_netflixJob, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_netflixJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NEWPROJECT_netflixJob) {
				...
				try {
					...
					this.MovieCoount = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.MovieCoount, dos);
		...
		public String toString() {
			...
			sb.append(",MovieCoount=" + String.valueOf(MovieCoount));
			sb.append("]");
...
// ------------
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						"D:/netflix_titles.csv"/** End field tFileInputDelimited_1:FILENAME */
				;
...
// Start of branch "row1"
						if (row1 != null) {
							...
							for (int i_tNormalize_1 = 0; i_tNormalize_1 < lastNoEmptyIndex_tNormalize_1; i_tNormalize_1++) {
								...
								row5.show_id = row1.show_id;

								row5.type = row1.type;

								row5.title = row1.title;

								row5.director = row1.director;

								row5.cast = row1.cast;

								row5.country = normalizeRecord_tNormalize_1[i_tNormalize_1];

								row5.date_added = row1.date_added;

								row5.release_year = row1.release_year;

								row5.rating = row1.rating;

								row5.duration = row1.duration;

								row5.listed_in = row1.listed_in;
								...
								operation_finder_tAggregateRow_1.country = row5.country;
								...
								operation_result_tAggregateRow_1.MovieCoount_clmCount++;
				...
				class Comparablerow4Struct extends row4Struct implements Comparable<Comparablerow4Struct> {
					...
					public int compareTo(Comparablerow4Struct other) {
						...
						if (this.MovieCoount == null && other.MovieCoount != null) {
							return 1;

						} else if (this.MovieCoount != null && other.MovieCoount == null) {
							return -1;

						} else if (this.MovieCoount != null && other.MovieCoount != null) {
							if (!this.MovieCoount.equals(other.MovieCoount)) {
								return other.MovieCoount.compareTo(this.MovieCoount);
							}
						}
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row2.MovieCoount = (int) aggregated_row_tAggregateRow_1.count;
					row2.MovieCoount = (int) aggregated_row_tAggregateRow_1.MovieCoount_clmCount;
					...
					if (ope_tFilterRow_1.getMatchFlag()) {
						...
						row4.MovieCoount = row2.MovieCoount;
...
// Start of branch "row4"
					if (row4 != null) {
						...
						arrayRowtSortRow_1_SortOut.MovieCoount = row4.MovieCoount;
				...
				util_tLogRow_1.addRow(new String[] { "country", "MovieCoount", });
...
///////////////////////    			
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/out2.csv")).getAbsolutePath()
								.replace("\\", "/");
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					headColutFileOutputDelimited_1[1] = "MovieCoount";
				...
				for (int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++) {
					...
					row3.country = current_tSortRow_1_SortIn.country;
					row3.MovieCoount = current_tSortRow_1_SortIn.MovieCoount;
					...
					row6.MovieCoount = row3.MovieCoount;
					row7 = new row7Struct();

					row7.country = row3.country;
					row7.MovieCoount = row3.MovieCoount;
...
///////////////////////		
					...
					if (row6.country != null) { //
						row_tLogRow_1[0] = String.valueOf(row6.country);

					} //

					if (row6.MovieCoount != null) { //
						row_tLogRow_1[1] = String.valueOf(row6.MovieCoount);
...
///////////////////////    			
					...
					rowtFileOutputDelimited_1[0] = row7.country == null ? null : row7.country;
					rowtFileOutputDelimited_1[1] = row7.MovieCoount == null ? null : String.valueOf(row7.MovieCoount);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final netflixJob netflixJobClass = new netflixJob();

		int exitCode = netflixJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = netflixJob.class.getClassLoader()
					.getResourceAsStream("newproject/netflixjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = netflixJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : netflixJob");
		}
...
/************************************************************************************************
 * 156029 characters generated by Talend Open Studio for Data Integration on the
 * October 17, 2023 at 9:32:21 AM EET
 ************************************************************************************************/