...
package newproject.tfilter_0_1;
 ...
 * @status
 */
public class Tfilter implements TalendJob {
	...
	private final String jobName = "Tfilter";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Tfilter.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_NEWPROJECT_Tfilter = new byte[0];
		static byte[] commonByteArray_NEWPROJECT_Tfilter = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_NEWPROJECT_Tfilter.length) {
					if (length < 1024 && commonByteArray_NEWPROJECT_Tfilter.length == 0) {
						commonByteArray_NEWPROJECT_Tfilter = new byte[1024];
					} else {
						commonByteArray_NEWPROJECT_Tfilter = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_NEWPROJECT_Tfilter, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_Tfilter, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_NEWPROJECT_Tfilter, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_Tfilter, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NEWPROJECT_Tfilter) {
				...
				try {
					...
					this.UnitPrice = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.UnitPrice, dos);
...
///////////////////////    			
				...
				String fileName_tFileOutputExcel_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/outTfilter.xls";
...
//create directory only if not exists
				...
				if (startRowNum_tFileOutputExcel_1 == 0) {
					...
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(0, nb_line_tFileOutputExcel_1, "ProductID"));
					// modif end
					fitWidth_tFileOutputExcel_1[0] = fitWidth_tFileOutputExcel_1[0] > 9 ? fitWidth_tFileOutputExcel_1[0]
							: 9;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(1, nb_line_tFileOutputExcel_1, "ProductName"));
					// modif end
					...
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(2, nb_line_tFileOutputExcel_1, "SupplierID"));
					// modif end
					fitWidth_tFileOutputExcel_1[2] = fitWidth_tFileOutputExcel_1[2] > 10
							? fitWidth_tFileOutputExcel_1[2]
							: 10;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(3, nb_line_tFileOutputExcel_1, "CategoryID"));
					// modif end
					fitWidth_tFileOutputExcel_1[3] = fitWidth_tFileOutputExcel_1[3] > 10
							? fitWidth_tFileOutputExcel_1[3]
							: 10;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(4, nb_line_tFileOutputExcel_1, "QuantityPerUnit"));
					// modif end
					fitWidth_tFileOutputExcel_1[4] = fitWidth_tFileOutputExcel_1[4] > 15
							? fitWidth_tFileOutputExcel_1[4]
							: 15;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(5, nb_line_tFileOutputExcel_1, "UnitPrice"));
					// modif end
					fitWidth_tFileOutputExcel_1[5] = fitWidth_tFileOutputExcel_1[5] > 9 ? fitWidth_tFileOutputExcel_1[5]
							: 9;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(6, nb_line_tFileOutputExcel_1, "UnitsInStock"));
					// modif end
					fitWidth_tFileOutputExcel_1[6] = fitWidth_tFileOutputExcel_1[6] > 12
							? fitWidth_tFileOutputExcel_1[6]
							: 12;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(7, nb_line_tFileOutputExcel_1, "UnitsOnOrder"));
					// modif end
					fitWidth_tFileOutputExcel_1[7] = fitWidth_tFileOutputExcel_1[7] > 12
							? fitWidth_tFileOutputExcel_1[7]
							: 12;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(8, nb_line_tFileOutputExcel_1, "ReorderLevel"));
					// modif end
					fitWidth_tFileOutputExcel_1[8] = fitWidth_tFileOutputExcel_1[8] > 12
							? fitWidth_tFileOutputExcel_1[8]
							: 12;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(9, nb_line_tFileOutputExcel_1, "Discontinued"));
					// modif end
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:rWOUX8zo6w+PQw3nDru2A0SSkuoF4N/bYTw1dg==");
				...
				String dbquery_tDBInput_1 = "SELECT dbo.Products.ProductID,\n		dbo.Products.ProductName,\n		dbo.Products.SupplierID,\n		dbo.Products.CategoryID,\n		dbo."
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.SupplierID = rs_tDBInput_1.getInt(3);
							if (rs_tDBInput_1.wasNull()) {
								row1.SupplierID = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							row1.CategoryID = rs_tDBInput_1.getInt(4);
							if (rs_tDBInput_1.wasNull()) {
								row1.CategoryID = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.QuantityPerUnit = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.QuantityPerUnit = tmpContent_tDBInput_1;
								}
							} else {
								row1.QuantityPerUnit = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							row1.UnitPrice = rs_tDBInput_1.getInt(6);
							if (rs_tDBInput_1.wasNull()) {
								row1.UnitPrice = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							row1.UnitsInStock = rs_tDBInput_1.getShort(7);
							if (rs_tDBInput_1.wasNull()) {
								row1.UnitsInStock = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							row1.UnitsOnOrder = rs_tDBInput_1.getShort(8);
							if (rs_tDBInput_1.wasNull()) {
								row1.UnitsOnOrder = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							...
							row1.ReorderLevel = rs_tDBInput_1.getShort(9);
							if (rs_tDBInput_1.wasNull()) {
								row1.ReorderLevel = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							...
							row1.Discontinued = rs_tDBInput_1.getBoolean(10);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						ope_tFilterRow_1
								.matches(
										(row1.UnitPrice == null ? false
												: row1.UnitPrice.compareTo(
														ParserUtils.parseTo_Integer(String.valueOf(10))) > 0),
										"UnitPrice.compareTo(10) > 0 failed");
						...
						if (ope_tFilterRow_1.getMatchFlag()) {
							...
							row2.ProductName = row1.ProductName;
							row2.SupplierID = row1.SupplierID;
							row2.CategoryID = row1.CategoryID;
							row2.QuantityPerUnit = row1.QuantityPerUnit;
							row2.UnitPrice = row1.UnitPrice;
							row2.UnitsInStock = row1.UnitsInStock;
							row2.UnitsOnOrder = row1.UnitsOnOrder;
							row2.ReorderLevel = row1.ReorderLevel;
							row2.Discontinued = row1.Discontinued;
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row3.CategoryID = row2.CategoryID;
							row3.QuantityPerUnit = row2.QuantityPerUnit;
							row3.UnitPrice = row2.UnitPrice;
							row3.UnitsInStock = row2.UnitsInStock;
							row3.UnitsOnOrder = row2.UnitsOnOrder;
							row3.ReorderLevel = row2.ReorderLevel;
							row3.Discontinued = row2.Discontinued;
							row4 = new row4Struct();

							row4.ProductID = row2.ProductID;
							row4.ProductName = row2.ProductName;
							row4.SupplierID = row2.SupplierID;
							row4.CategoryID = row2.CategoryID;
							row4.QuantityPerUnit = row2.QuantityPerUnit;
							row4.UnitPrice = row2.UnitPrice;
							row4.UnitsInStock = row2.UnitsInStock;
							row4.UnitsOnOrder = row2.UnitsOnOrder;
							row4.ReorderLevel = row2.ReorderLevel;
							row4.Discontinued = row2.Discontinued;
...
///////////////////////		
							...
							strBuffer_tLogRow_1.append(String.valueOf(row3.ProductID));

							strBuffer_tLogRow_1.append("|");

							if (row3.ProductName != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row3.ProductName));
							...
							if (row3.SupplierID != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row3.SupplierID));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row3.CategoryID != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row3.CategoryID));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row3.QuantityPerUnit != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row3.QuantityPerUnit));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row3.UnitPrice != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row3.UnitPrice));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row3.UnitsInStock != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row3.UnitsInStock));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row3.UnitsOnOrder != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row3.UnitsOnOrder));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row3.ReorderLevel != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row3.ReorderLevel));

							} //

							strBuffer_tLogRow_1.append("|");

							strBuffer_tLogRow_1.append(String.valueOf(row3.Discontinued));
...
//modif start
							...
							jxl.write.WritableCell cell_9_tFileOutputExcel_1 = new jxl.write.Boolean(
									columnIndex_tFileOutputExcel_1,
									startRowNum_tFileOutputExcel_1 + nb_line_tFileOutputExcel_1,
...
//modif ends							
							...
							int currentWith_9_tFileOutputExcel_1 = cell_9_tFileOutputExcel_1.getContents().trim()
									.length();
							currentWith_9_tFileOutputExcel_1 = 5;
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Tfilter TfilterClass = new Tfilter();

		int exitCode = TfilterClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Tfilter.class.getClassLoader()
					.getResourceAsStream("newproject/tfilter_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Tfilter.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Tfilter");
		}
...
/************************************************************************************************
 * 117695 characters generated by Talend Open Studio for Data Integration on the
 * October 17, 2023 at 6:10:37 PM EET
 ************************************************************************************************/