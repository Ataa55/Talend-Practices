...
package newproject.jsonread_0_1;
 ...
 * @status
 */
public class JSONRead implements TalendJob {
	...
	private final String jobName = "JSONRead";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JSONRead.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_NEWPROJECT_JSONRead = new byte[0];
		static byte[] commonByteArray_NEWPROJECT_JSONRead = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_NEWPROJECT_JSONRead.length) {
					if (length < 1024 && commonByteArray_NEWPROJECT_JSONRead.length == 0) {
						commonByteArray_NEWPROJECT_JSONRead = new byte[1024];
					} else {
						commonByteArray_NEWPROJECT_JSONRead = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_NEWPROJECT_JSONRead, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_JSONRead, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_NEWPROJECT_JSONRead, 0, length);
				strReturn = new String(commonByteArray_NEWPROJECT_JSONRead, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NEWPROJECT_JSONRead) {
	...
	public void tFileInputJSON_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fileName_tFileOutputExcel_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/outJSON.xls";
...
//create directory only if not exists
				...
				if (startRowNum_tFileOutputExcel_1 == 0) {
					...
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(0, nb_line_tFileOutputExcel_1, "value"));
					// modif end
					fitWidth_tFileOutputExcel_1[0] = fitWidth_tFileOutputExcel_1[0] > 5 ? fitWidth_tFileOutputExcel_1[0]
							: 5;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(1, nb_line_tFileOutputExcel_1, "onclick"));
					// modif end
				...
				String loopPath_tFileInputJSON_1 = "$.menu.popup.menuitem[*]";
				...
				try {
					filenameOrStream_tFileInputJSON_1 = "D:/Data/Data Engineering_ITI/Data Exploration and preparation/day_5/intake3-20231017T062812Z-001/intake3/json.json";
				...
				for (Object row_tFileInputJSON_1 : resultset_tFileInputJSON_1) {
					...
					try {
						...
						jsonPath_tFileInputJSON_1 = "onclick";
						compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1
								.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
						...
						try {
							...
							row1.onclick = value_tFileInputJSON_1 == null ?
...
//modif ends							
	...
	public static void main(String[] args) {
		final JSONRead JSONReadClass = new JSONRead();

		int exitCode = JSONReadClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JSONRead.class.getClassLoader()
					.getResourceAsStream("newproject/jsonread_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = JSONRead.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : JSONRead");
		}
...
/************************************************************************************************
 * 44663 characters generated by Talend Open Studio for Data Integration on the
 * October 17, 2023 at 11:49:05 AM EET
 ************************************************************************************************/